...
/**
 * An unoptimized Spherical K-Means optimization based on {@link HamerlyKMeans}.
 ...
 * @param <V>
 */
public class HamerlyUnoptimizedSphericalKMeans<V extends NumberVector> extends HamerlyKMeans<V> {
  /**
   * The logger for this class.
   */
  private static final Logging LOG = Logging.getLogger(HamerlyUnoptimizedSphericalKMeans.class);

  public HamerlyUnoptimizedSphericalKMeans(int k, int maxiter, KMeansInitialization initializer, boolean varstat) {
  ...
  public static class Par<V extends NumberVector> extends AbstractKMeans.Par<V> {
    ...
    @Override
    public HamerlyUnoptimizedSphericalKMeans<V> make() {
      return new HamerlyUnoptimizedSphericalKMeans<>(k, maxiter, initializer, varstat);
    }
  }
}
