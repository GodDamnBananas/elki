...
/**
 * An unoptimized Spherical K-Means optimization based on {@link ElkanKMeans}.
 ...
 * @param <V>
 */
public class ElkanUnoptimizedSphericalKMeans<V extends NumberVector> extends ElkanKMeans<V> {
  /**
   * The logger for this class.
   */
  private static final Logging LOG = Logging.getLogger(ElkanUnoptimizedSphericalKMeans.class);
   ...
   * @author Alexander Voﬂ
   */
  protected static class Instance extends ElkanKMeans.Instance {
   ...
   * @author Alexander Voﬂ
   */
  public static class Par<V extends NumberVector> extends ElkanKMeans.Par<V> {
    @Override
    public ElkanUnoptimizedSphericalKMeans<V> make() {
      return new ElkanUnoptimizedSphericalKMeans<>(k, maxiter, initializer, varstat);
    }
  }
}
